...
/**
 * @license ResponsiveVoice JS v1.4.5a
 *
 * (c) 2015 LearnBrite
 *
...
if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
        ...
        self.responsivevoices = [
            ...
            {name: 'UK English Male', flag: 'gb', gender: 'm', voiceIDs: [0, 4, 2, 75, 202, 7, 159, 6]},
        ...
        self.speak = function (text, voicename, parameters) {
            ...
            for (var i = 0; i < multipartText.length; i++) {
                ...
                if (navigator.userAgent.toLowerCase().indexOf('android') + 1) self.fallbackMode = false; //!!!!!!! Changes for the 1.4.5a version
